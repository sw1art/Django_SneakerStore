...
from .models import Sneaker, Brand, Size


class SneakerTets(TestCase):
    def setUp(self):
        self.brand = Brand.objects.create(name='Nike', description='Nike brand')
        self.size = Size.objects.create(size_us=10.5, size_ru=43, size_eu=44, size_uk=9.5, size_cm=27)
    ...
    def test_sneaker_creation(self):
        ...
        self.assertEqual(self.sneaker.price, 150.00)
    ...
    def test_brand_creation(self):
        brand = Brand.objects.create(name='Adidas', description='Adidas brand')
    ...
    def test_size_creation(self):
        size = Size.objects.create(size_us=9.0, size_ru=42, size_eu=43, size_uk=8.0, size_cm=26)
    ...
    def test_sneaker_list_view(self):
        ...
        self.assertContains(response, self.sneaker.title)
